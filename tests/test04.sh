...
do_check ()
{
    ...
    ./bdsync           --diffsize "./bdsync -s" $REMDEV $LOCDEV > $BDSYNC3 || abort_msg "bdsync (3) failed"
...
handle_check do_check "Handling different size (random) files with --diffsize option"
